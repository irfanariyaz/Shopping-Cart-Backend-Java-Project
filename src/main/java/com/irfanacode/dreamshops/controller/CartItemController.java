...
import com.irfanacode.dreamshops.service.cart.ICartItemService;
...
public class CartItemController {
    ...
    private  final IUserService userService; @PostMapping("/item/add")
    ...
    public ResponseEntity<ApiResponse> addItemToCart(
        ...
        try {
            ...
            cartItemService.addItemsToCart(cart.getId(), productId, quantity);
